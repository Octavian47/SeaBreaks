...
const HeroSlider = () => {
  ...
  return <div id="slider-section" className="slider-section">
      <div id="revo_main_wrapper" className="rev_slider_wrapper fullwidthbanner-container m-0 p-0 bg-dark">
      ...
      <svg id="svg-wave" preserveAspectRatio="xMidYMax meet" className="svg-separator sep1" viewBox="0 0 1600 100" style={{}} data-height={100}>
        <path style={{
        opacity: 1,
        fill: '#ffffff'
      }} d="M1040,56c0.5,0,1,0,1.6,0c-16.6-8.9-36.4-15.7-66.4-15.7c-56,0-76.8,23.7-106.9,41C881.1,89.3,895.6,96,920,96 C979.5,96,980,56,1040,56z" />
        <path style={{
        opacity: 1,
        fill: '#ffffff'
        ...
        opacity: 1,
        fill: '#ffffff'
      }} d="M-40,95.6c28.3,0,43.3-8.7,57.4-18C-9.6,60.8-31,40.2-83.2,40.2c-14.3,0-26.3,1.6-36.8,4.2V106h60V96L-40,95.6 z" />
        <path style={{
        opacity: 1,
        fill: '#ffffff'
        ...
        fill: '#ffffff',
        stroke: '#ffffff'
      }} d="M25.5,72C6,72,6.1,84.9-13.5,84.9L-20,85v8.9C0.7,90.1,12.6,80.6,25.9,72C25.8,72,25.7,72,25.5,72z" /> <path style={{
